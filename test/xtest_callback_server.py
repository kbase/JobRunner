...
class CallbackServerTest(helper.CPWebCase):
    ...
    def test_submit(self):
        body = json.dumps({"method": "app._bogus_submit", "params": ["1234"]})
        headers = [
        ...
        body = json.dumps({"method": "app._check_job", "params": ["1234"]})
    ...
    def test_prov(self):
        body = json.dumps({"method": "app.get_provenance", "params": ["1234"]})
